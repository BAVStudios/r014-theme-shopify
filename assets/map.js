...
//Below Added by BAVStudios 2025-03-25. 
//This allows for red marker to be clickable.
/*
renderMarker(index, location) {
	const lat = parseFloat(location.dataset.latitude);
	const lng = parseFloat(location.dataset.longitude);
	const marker = new google.maps.Marker({
		position: { lat, lng },
		map: this.map,
		title: location.dataset.title || "Our Store"
	});

	// Open Google Maps directions on click
